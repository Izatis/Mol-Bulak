...
document.querySelectorAll(".give__left-box-form-inputs-label-range").forEach(function(ctrl) {
    let el = ctrl.querySelector('.give__left-box-form-inputs-label-range-input');
    el.oninput =function(){
